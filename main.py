...
def movies():
	...
	interstellar = Movie('Interstellar', 'PG-13',
						...
						'https://d3ui957tjb5bqd.cloudfront.net/uploads/2014/11/interstellar-poster-2.jpg', # NOQA
						'https://www.youtube.com/embed/2LqzF5WauAw')

	star_wars = Movie('Star Wars: The Force Awakens', 'PG-13',
						'There has been an awakening...',
						'http://3.bp.blogspot.com/-0_6xjfnrpzk/Vl7mYARXTsI/AAAAAAABNh4/0PoZ4-vN00s/s1600/Star%2BWars%2B-%2BThe%2BForce%2BAwakens%2Bby%2BBryan%2BMorton_1.jpg', # NOQA
						'https://www.youtube.com/embed/sGbxmsDFVnE')

	social_network = Movie('The Social Network', 'PG-13',
						'Facebook in its infancy',
						'http://www.collegeadmissionsbible.com/wp-content/uploads/2013/03/0000the-social-network.jpg', # NOQA
